...
const OLYMPIADS = [
  ...
  { id:'onhb',       acronym:'ONHB',                    name:'Olimpíada Nacional em História do Brasil',                              area:'História',             deadline:'10/06/2026', status:'inscricoes-abertas',  phases:5, fee:'Gratuita', level:'Fund. e Médio',          c1:'#d97706',c2:'#b45309' },
  ...
  { id:'olitef',     acronym:'OLITEF',                  name:'Olimpíada do Tesouro Direto de Educação Financeira',                    area:'Educação Financeira',  deadline:'20/06/2026', status:'inscricoes-abertas',  phases:2, fee:'Gratuita', level:'Ensino Médio',           c1:'#7c3aed',c2:'#6d28d9' },
  { id:'obr',        acronym:'OBR',                     name:'Olimpíada Brasileira de Robótica',                                     area:'Robótica / Tecnologia', deadline:'12/06/2026', status:'inscricoes-abertas',  phases:3, fee:'Gratuita', level:'Fund. e Médio',          c1:'#2563eb',c2:'#1d4ed8' },
  ...
  { id:'oceano',     acronym:'OO',                      name:'Olimpíada do Oceano',                                                   area:'Ciências Ambientais',  deadline:'30/07/2026', status:'inscricoes-fechadas', phases:2, fee:'Gratuita', level:'Fund. e Médio',          c1:'#0284c7',c2:'#0369a1' },
  { id:'tff',        acronym:'TORNEIO FEMININO DE FÍSICA',name:'Torneio de Física para Meninas',                                    area:'Física',               deadline:'22/06/2026', status:'inscricoes-abertas',  phases:2, fee:'Gratuita', level:'Ensino Médio',           c1:'#db2777',c2:'#be185d', femaleOnly:true },
  { id:'canguru',    acronym:'CANGURU',                 name:'Canguru de Matemática Brasil',                                         area:'Matemática',           deadline:'18/05/2026', status:'encerrada',           phases:1, fee:'Gratuita', level:'Fund. e Médio',          c1:'#ea580c',c2:'#c2410c' },
  { id:'obsma',      acronym:'OBSMA',                   name:'Olimpíada Brasileira de Saúde e Meio Ambiente',                        area:'Saúde / Meio Ambiente', deadline:'28/06/2026', status:'inscricoes-abertas',  phases:3, fee:'Gratuita', level:'Ensino Médio',           c1:'#16a34a',c2:'#15803d' },
  { id:'obmep',      acronym:'OBMEP',                   name:'Olimpíada Brasileira de Matemática das Escolas Públicas',              area:'Matemática',           deadline:'30/06/2026', status:'em-andamento',        phases:2, fee:'Gratuita', level:'Fund. II e Médio',       c1:'#dc2626',c2:'#b91c1c' },
  { id:'obapo',      acronym:'OBAPO',                   name:'Olimpíada Brasileira de Africanidades e Povos Originários',         area:'Multidisciplinar',     deadline:'15/05/2026', status:'encerrada',           phases:2, fee:'Gratuita', level:'Fund. e Médio',          c1:'#4f46e5',c2:'#4338ca' },
  { id:'obi',        acronym:'OBI',                     name:'Olimpíada Brasileira de Informática',                                  area:'Informática',          deadline:'05/08/2026', status:'inscricoes-fechadas', phases:3, fee:'Gratuita', level:'Fund. e Médio',          c1:'#0369a1',c2:'#075985' },
  { id:'obqjr',      acronym:'OBQJr',                   name:'Olimpíada Brasileira de Química Júnior',                               area:'Química',              deadline:'20/07/2026', status:'inscricoes-abertas',  phases:2, fee:'Gratuita', level:'Fundamental II',         c1:'#9333ea',c2:'#7e22ce' },
  { id:'matdiv',     acronym:'OMpD',                   name:'Matemática por Diversão',                                             area:'Matemática',           deadline:'10/07/2026', status:'inscricoes-fechadas', phases:2, fee:'Gratuita', level:'Fund. e Médio',          c1:'#f59e0b',c2:'#d97706' },
  ...
  { id:'olimplit',   acronym:'OLIMPÍADA DE LITERATURA', name:'Olimpíada de Literatura',                                              area:'Literatura',           deadline:'08/07/2026', status:'inscricoes-fechadas', phases:2, fee:'Paga',         level:'Ensino Médio',           c1:'#8b5cf6',c2:'#7c3aed' },
  { id:'purple',     acronym:'PURPLE COMET',            name:'Purple Comet Math Meet',                                               area:'Matemática',           deadline:'02/06/2026', status:'encerrada',           phases:1, fee:'Gratuita', level:'Fund. e Médio',          c1:'#a855f7',c2:'#9333ea' },
  { id:'oba',        acronym:'OBA',                     name:'Olimpíada Brasileira de Astronomia e Astronáutica',                   area:'Astronomia',           deadline:'15/05/2026', status:'em-andamento',        phases:2, fee:'Gratuita', level:'Fund. e Médio',          c1:'#1e40af',c2:'#1e3a8a' },
  { id:'osequim',    acronym:'OSEQUIM',                 name:'Olimpíada Sergipana de Química',                                       area:'Química',              deadline:'25/07/2026', status:'inscricoes-abertas',  phases:2, fee:'Gratuita', level:'Ensino Médio',           c1:'#7c3aed',c2:'#6d28d9' },
  { id:'obafof',     acronym:'OBAFOF',                  name:'Olimpíada Brasileira de Foguetes',                                     area:'Física / Astronomia',  deadline:'18/07/2026', status:'inscricoes-abertas',  phases:1, fee:'Gratuita', level:'Fund. e Médio',          c1:'#0284c7',c2:'#0369a1' },
  { id:'ofv',        acronym:'OVF',                     name:'Olimpíada Virtual de Física',                                          area:'Física',               deadline:'30/06/2026', status:'inscricoes-fechadas', phases:2, fee:'Gratuita', level:'Ensino Médio',           c1:'#64748b',c2:'#475569' },
  ...
  { id:'obf',        acronym:'OBF',                     name:'Olimpíada Brasileira de Física',                                       area:'Física',               deadline:'10/08/2026', status:'inscricoes-abertas',  phases:3, fee:'Paga',         level:'Ensino Médio',           c1:'#1e293b',c2:'#0f172a' }
];
